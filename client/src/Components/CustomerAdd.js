    ...
    render() {
        return (
            <form onSubmit={this.handleFormSubmit}>
                <h1>個客　追加</h1>
                プロフィール　イメージ: <input type="file" name="file" file={this.state.file} value={this.state.fileName} onChange={this.handleFileChange}/><br/>
                お名前: <input type="text" name="userName" value={this.state.userName} onChange={this.handleValueChange}/><br/>
